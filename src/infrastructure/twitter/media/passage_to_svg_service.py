...
class PassageToSvgService(AbstractPassageToSvgService):
    ...
    def should_adjust_size_of_svg(self, svg_content: str, passage_text: str):
        ...
        messages = [
            {
                'role': 'user',
                'content': f"Passage: {passage_text}, SVG code: {svg_content}"
            }
        ]
        ...
        tools = [
            {
                ...
                'input_schema': {
                    'type': 'object',
                    'properties': {'is_svg_correct': {'type': 'boolean', 'description': 'true or false, whether the SVG shows the passage correctly ot not!'}},  # noqa: E501
        ...
        tools = [
            {
                ...
                'input_schema': {
                    'type': 'object',
                    'properties': {'refactor_svg_code': {'type': 'string', 'description': 'The generated refactored SVG code with adjusted height.'}},  # noqa: E501
